 ...
 *  Return a uniform 2D vector on the unit circle.
 *
 */
vec2 noise2(vec4 x)
{
	...
	return  mix(mix(mix(mix(rand2(v + vec4(0.0, 0.0, 0.0, 0.0)), rand2(v + vec4(0.0, 0.0, 0.0, 1.0)), c.q),
						mix(rand2(v + vec4(0.0, 0.0, 1.0, 0.0)), rand2(v + vec4(0.0, 0.0, 1.0, 1.0)), c.q), c.p),
					mix(mix(rand2(v + vec4(0.0, 1.0, 0.0, 0.0)), rand2(v + vec4(0.0, 1.0, 0.0, 1.0)), c.q),
						mix(rand2(v + vec4(0.0, 1.0, 1.0, 0.0)), rand2(v + vec4(0.0, 1.0, 1.0, 1.0)), c.q), c.p), c.t),
				mix(mix(mix(rand2(v + vec4(1.0, 0.0, 0.0, 0.0)), rand2(v + vec4(1.0, 0.0, 0.0, 1.0)), c.q),
						mix(rand2(v + vec4(1.0, 0.0, 1.0, 0.0)), rand2(v + vec4(1.0, 0.0, 1.0, 1.0)), c.q), c.p),
					mix(mix(rand2(v + vec4(1.0, 1.0, 0.0, 0.0)), rand2(v + vec4(1.0, 1.0, 0.0, 1.0)), c.q),
						mix(rand2(v + vec4(1.0, 1.0, 1.0, 0.0)), rand2(v + vec4(1.0, 1.0, 1.0, 1.0)), c.q), c.p), c.t), c.s);
...
vec2 noise2(vec3 x)
{
	...
	return  mix(mix(mix(rand2(v + vec4(0.0, 0.0, 0.0, 0.0)), rand2(v + vec4(0.0, 0.0, 1.0, 0.0)), c.p),
					mix(rand2(v + vec4(0.0, 1.0, 0.0, 0.0)), rand2(v + vec4(0.0, 1.0, 1.0, 0.0)), c.p), c.t),
				mix(mix(rand2(v + vec4(1.0, 0.0, 0.0, 0.0)), rand2(v + vec4(1.0, 0.0, 1.0, 0.0)), c.p),
					mix(rand2(v + vec4(1.0, 1.0, 0.0, 0.0)), rand2(v + vec4(1.0, 1.0, 1.0, 0.0)), c.p), c.t), c.s);
...
vec2 noise2(vec2 x)
{
	...
	return  mix(mix(rand2(v + vec4(0.0, 0.0, 0.0, 0.0)), rand2(v + vec4(0.0, 1.0, 0.0, 0.0)), c.t),
				mix(rand2(v + vec4(1.0, 0.0, 0.0, 0.0)), rand2(v + vec4(1.0, 1.0, 0.0, 0.0)), c.t), c.s);
...
vec2 noise2(float x)
{
	...
	return mix(rand2(v + vec4(0.0, 0.0, 0.0, 0.0)), rand2(v + vec4(1.0, 0.0, 0.0, 0.0)), c);
 ...
 *
 */
vec2 fbm2(vec4 x, float f0, float df, float a0, float da, int N)
{
	vec2  s = vec2(0.0);
	float a = a0, f = f0;
 ...
 *
 */
vec2 fbm2(vec3 x, float f0, float df, float a0, float da, int N)
{
	vec2  s = vec2(0.0);
	float a = a0, f = f0;
 ...
 *
 */
vec2 fbm2(vec2 x, float f0, float df, float a0, float da, int N)
{
	vec2  s = vec2(0.0);
	float a = a0, f = f0;
 ...
 *
 */
vec2 fbm2(float x, float f0, float df, float a0, float da, int N)
{
	vec2  s = vec2(0.0);
	float a = a0, f = f0;
