...
#section
#infdef _ORION_NOISE_1D_GLSL_H
#define _ORION_NOISE_1D_GLSL_H


/**
 *
 *  1D GLSL noise functions
 *
 ...
 *  Return a float in the [-1.0, +1.0] range.
 *
 */
float noise1(vec4 x)
{
	...
	return  mix(mix(mix(mix(rand1(v + vec4(0.0, 0.0, 0.0, 0.0)), rand1(v + vec4(0.0, 0.0, 0.0, 1.0)), c.q),
						mix(rand1(v + vec4(0.0, 0.0, 1.0, 0.0)), rand1(v + vec4(0.0, 0.0, 1.0, 1.0)), c.q), c.p),
					mix(mix(rand1(v + vec4(0.0, 1.0, 0.0, 0.0)), rand1(v + vec4(0.0, 1.0, 0.0, 1.0)), c.q),
						mix(rand1(v + vec4(0.0, 1.0, 1.0, 0.0)), rand1(v + vec4(0.0, 1.0, 1.0, 1.0)), c.q), c.p), c.t),
				mix(mix(mix(rand1(v + vec4(1.0, 0.0, 0.0, 0.0)), rand1(v + vec4(1.0, 0.0, 0.0, 1.0)), c.q),
						mix(rand1(v + vec4(1.0, 0.0, 1.0, 0.0)), rand1(v + vec4(1.0, 0.0, 1.0, 1.0)), c.q), c.p),
					mix(mix(rand1(v + vec4(1.0, 1.0, 0.0, 0.0)), rand1(v + vec4(1.0, 1.0, 0.0, 1.0)), c.q),
						mix(rand1(v + vec4(1.0, 1.0, 1.0, 0.0)), rand1(v + vec4(1.0, 1.0, 1.0, 1.0)), c.q), c.p), c.t), c.s);
...
float noise1(vec3 x)
{
	...
	return  mix(mix(mix(rand1(v + vec4(0.0, 0.0, 0.0, 0.0)), rand1(v + vec4(0.0, 0.0, 1.0, 0.0)), c.p),
					mix(rand1(v + vec4(0.0, 1.0, 0.0, 0.0)), rand1(v + vec4(0.0, 1.0, 1.0, 0.0)), c.p), c.t),
				mix(mix(rand1(v + vec4(1.0, 0.0, 0.0, 0.0)), rand1(v + vec4(1.0, 0.0, 1.0, 0.0)), c.p),
					mix(rand1(v + vec4(1.0, 1.0, 0.0, 0.0)), rand1(v + vec4(1.0, 1.0, 1.0, 0.0)), c.p), c.t), c.s);
...
float noise1(vec2 x)
{
	...
	return  mix(mix(rand1(v + vec4(0.0, 0.0, 0.0, 0.0)), rand1(v + vec4(0.0, 1.0, 0.0, 0.0)), c.t),
				mix(rand1(v + vec4(1.0, 0.0, 0.0, 0.0)), rand1(v + vec4(1.0, 1.0, 0.0, 0.0)), c.t), c.s);
...
float noise1(float x)
{
	...
	return mix(rand1(v + vec4(0.0, 0.0, 0.0, 0.0)), rand1(v + vec4(1.0, 0.0, 0.0, 0.0)), c);
 ...
 *
 */
float fbm1(vec4 x, float f0, float df, float a0, float da, int N)
{
	float s = 0.0;
	float a = a0, f = f0;
 ...
 *
 */
float fbm1(vec3 x, float f0, float df, float a0, float da, int N)
{
	float s = 0.0;
	float a = a0, f = f0;
 ...
 *
 */
float fbm1(vec2 x, float f0, float df, float a0, float da, int N)
{
	float s = 0.0;
	float a = a0, f = f0;
 ...
 *
 */
float fbm1(float x, float f0, float df, float a0, float da, int N)
{
	float s = 0.0;
	float a = a0, f = f0;
