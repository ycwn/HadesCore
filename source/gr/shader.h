...
typedef struct gr_shader {
	...
	VkPipeline      pipeline;
	VkShaderModule  module[GR_SHADER_MAX];
	const char     *entrypoints[GR_SHADER_MAX];

	VkViewport viewport;
	VkRect2D   scissor;

	VkVertexInputBindingDescription        vibd;
	VkVertexInputAttributeDescription      viad[GR_VERTEXATTR_MAX];
	VkPipelineShaderStageCreateInfo        pssci[GR_SHADER_MAX];
	...
	VkPipelineColorBlendAttachmentState    pcbas[GR_ATTACHMENTS_MAX];
