...
bool gr_texture_is_cube(const gr_texture *t) { return (t.flags & GR_TEXTURE_CUBEMAP) != 0; }
bool gr_texture_is_1d(  const gr_texture *t) { return !gr_texture_is_cube(t) && (t.height == 1) && (t.depth == 1); }
bool gr_texture_is_2d(  const gr_texture *t) { return !gr_texture_is_cube(t) && (t.height != 1) && (t.depth == 1); }
bool gr_texture_is_3d(  const gr_texture *t) { return !gr_texture_is_cube(t) && (t.depth  != 1); }
